...
> DreamcatcherWebPresidioPolicyControllerScan200Response dreamcatcher_web_zero_shot_ner_policy_controller_scan(endpoint_name, id, dreamcatcher_web_presidio_policy_controller_scan_request=dreamcatcher_web_presidio_policy_controller_scan_request)
...
with dreamcatcher.ApiClient(configuration) as api_client:
    ...
    try:
        # Scan content with a DLP ZSNER policy
        api_response = api_instance.dreamcatcher_web_zero_shot_ner_policy_controller_scan(endpoint_name, id, dreamcatcher_web_presidio_policy_controller_scan_request=dreamcatcher_web_presidio_policy_controller_scan_request)
