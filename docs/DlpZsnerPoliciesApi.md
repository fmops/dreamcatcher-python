# openapi_client.DlpZsnerPoliciesApi
...
[**dreamcatcher_web_zero_shot_ner_policy_controller_scan**](DlpZsnerPoliciesApi.md#dreamcatcher_web_zero_shot_ner_policy_controller_scan) | **POST** /api/v1/endpoints/{endpoint_name}/policies/dlp_zsner/{id}/scan | Scan content with a DLP ZSNER policy
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DlpZsnerPoliciesApi(api_client)
    endpoint_name = 'demo-endpoint' # str | Endpoint name
    dlp_zsner_policy_params = openapi_client.DlpZsnerPolicyParams() # DlpZsnerPolicyParams | DLP ZSNER policy params (optional)

    try:
        # Create a DLP ZSNER policy
        api_response = api_instance.dreamcatcher_web_zero_shot_ner_policy_controller_create(endpoint_name, dlp_zsner_policy_params=dlp_zsner_policy_params)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a DLP ZSNER policy
        api_instance.dreamcatcher_web_zero_shot_ner_policy_controller_delete(endpoint_name, id)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    endpoint_name = 'demo-endpoint' # str | Endpoint name
    id = 1 # int | DLP ZSNER Policy ID
    dreamcatcher_web_zero_shot_ner_policy_controller_scan_request = openapi_client.DreamcatcherWebZeroShotNERPolicyControllerScanRequest() # DreamcatcherWebZeroShotNERPolicyControllerScanRequest | Content to scan (optional)

    try:
        # Scan content with a DLP ZSNER policy
        api_response = api_instance.dreamcatcher_web_zero_shot_ner_policy_controller_scan(endpoint_name, id, dreamcatcher_web_zero_shot_ner_policy_controller_scan_request=dreamcatcher_web_zero_shot_ner_policy_controller_scan_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a DLP ZSNER policy
        api_response = api_instance.dreamcatcher_web_zero_shot_ner_policy_controller_show(endpoint_name, id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a DLP ZSNER policy
        api_response = api_instance.dreamcatcher_web_zero_shot_ner_policy_controller_update(endpoint_name, id, dlp_zsner_policy_params=dlp_zsner_policy_params)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a DLP ZSNER policy
        api_response = api_instance.dreamcatcher_web_zero_shot_ner_policy_controller_update__2(endpoint_name, id, dlp_zsner_policy_params=dlp_zsner_policy_params)
