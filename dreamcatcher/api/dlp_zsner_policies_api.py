...
class DlpZsnerPoliciesApi:
    ...
    async def dreamcatcher_web_zero_shot_ner_policy_controller_create(
        ...
        _param = self._dreamcatcher_web_zero_shot_ner_policy_controller_create_serialize(
            endpoint_name=endpoint_name,
            dlp_zsner_policy_params=dlp_zsner_policy_params,
    ...
    def _dreamcatcher_web_zero_shot_ner_policy_controller_create_serialize(
        self,
        endpoint_name,
        dlp_zsner_policy_params,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if dlp_zsner_policy_params is not None:
            _body_params = dlp_zsner_policy_params
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/endpoints/{endpoint_name}/policies/dlp_zsner',
    ...
    async def dreamcatcher_web_zero_shot_ner_policy_controller_delete(
        ...
        _param = self._dreamcatcher_web_zero_shot_ner_policy_controller_delete_serialize(
            endpoint_name=endpoint_name,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _dreamcatcher_web_zero_shot_ner_policy_controller_delete_serialize(
        self,
        endpoint_name,
        id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/endpoints/{endpoint_name}/policies/dlp_zsner/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def dreamcatcher_web_zero_shot_ner_policy_controller_scan(
        ...
        _param = self._dreamcatcher_web_zero_shot_ner_policy_controller_scan_serialize(
            endpoint_name=endpoint_name,
            id=id,
    ...
    def _dreamcatcher_web_zero_shot_ner_policy_controller_scan__2_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/endpoints/{endpoint_name}/policies/dlp_zsner/{id}/scan',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def dreamcatcher_web_zero_shot_ner_policy_controller_show(
        ...
        _param = self._dreamcatcher_web_zero_shot_ner_policy_controller_show_serialize(
            endpoint_name=endpoint_name,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _dreamcatcher_web_zero_shot_ner_policy_controller_show_serialize(
        self,
        endpoint_name,
        id,
        _request_auth,
    ...
    async def dreamcatcher_web_zero_shot_ner_policy_controller_update(
        ...
        _param = self._dreamcatcher_web_zero_shot_ner_policy_controller_update_serialize(
            endpoint_name=endpoint_name,
            id=id,
            dlp_zsner_policy_params=dlp_zsner_policy_params,
            _request_auth=_request_auth,
    ...
    def _dreamcatcher_web_zero_shot_ner_policy_controller_update_serialize(
        self,
        endpoint_name,
        id,
        dlp_zsner_policy_params,
    ...
    async def dreamcatcher_web_zero_shot_ner_policy_controller_update__2(
        ...
        _param = self._dreamcatcher_web_zero_shot_ner_policy_controller_update__2_serialize(
            endpoint_name=endpoint_name,
            id=id,
            dlp_zsner_policy_params=dlp_zsner_policy_params,
            _request_auth=_request_auth,
    ...
    def _dreamcatcher_web_zero_shot_ner_policy_controller_update__2_serialize(
        self,
        endpoint_name,
        id,
        dlp_zsner_policy_params,
