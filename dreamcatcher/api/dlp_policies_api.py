...
class DlpPoliciesApi:
    ...
    async def dreamcatcher_web_presidio_policy_controller_show(
        ...
        _param = self._dreamcatcher_web_presidio_policy_controller_show_serialize(
    ...
    def _dreamcatcher_web_presidio_policy_controller_show_serialize(
        self,
        endpoint_name,
        id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/endpoints/{endpoint_name}/policies/dlp/{id}',
