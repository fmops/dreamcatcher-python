...
class EndpointsApi:
    ...
    async def dreamcatcher_web_endpoint_controller_index(
        ...
        _param = self._dreamcatcher_web_endpoint_controller_index_serialize(
    ...
    async def dreamcatcher_web_endpoint_controller_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ListEndpointResponseInner]]:
        """List endpoints
    ...
    def _dreamcatcher_web_endpoint_controller_index_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    async def dreamcatcher_web_endpoint_controller_show(
        ...
        _param = self._dreamcatcher_web_endpoint_controller_show_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def dreamcatcher_web_endpoint_controller_show_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShowEndpointResponse]:
        """Get an endpoint
    ...
    def _dreamcatcher_web_endpoint_controller_show_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/endpoints/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
