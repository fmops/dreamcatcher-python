...
class EmbeddingResponseInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmbeddingResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmbeddingResponseInner:
        """Create an instance of EmbeddingResponseInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmbeddingResponseInner.parse_obj(obj)

        _obj = EmbeddingResponseInner.parse_obj({
