...
class ChatCompletionMessage(BaseModel):
    """
    A chat message in a conversation.  # noqa: E501
    """
    content: StrictStr = Field(...)
    role: StrictStr = Field(...)
    __properties = ["content", "role"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChatCompletionMessage:
    ...
    def from_dict(cls, obj: dict) -> ChatCompletionMessage:
        ...
        if not isinstance(obj, dict):
            return ChatCompletionMessage.parse_obj(obj)

        _obj = ChatCompletionMessage.parse_obj({
