...
class ContentModerationPolicy(BaseModel):
    ...
    blocked_content_types: Optional[List[StrictStr]] = None
    name: Optional[StrictStr] = None
    score_threshold: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["active", "blocked_content_types", "name", "score_threshold"]

    @field_validator('blocked_content_types')
    def blocked_content_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['toxic', 'obscene', 'insult', 'identity_hate', 'threat', 'severe_toxic']):
