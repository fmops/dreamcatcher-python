...
class DlpZsnerPolicyParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dlp_zsner_policy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dlp_zsner_policy": DlpZsnerPolicyParamsDlpZsnerPolicy.from_dict(obj["dlp_zsner_policy"]) if obj.get("dlp_zsner_policy") is not None else None
        })
        return _obj
